    ...
    const handleUndo = (habit) => {
        const updatedHabits = habits.map((h) => {
            if (h.name === habit.name) {
                ...
                return {
                    ...h,
                    completedDays: h.completedDays.filter(
                        (day) => day !== currentDay,
                    ),
                }
            }
    ...
    return (
        <div className="w-full rounded-lg bg-white p-6 shadow-md">
            <div className="flex justify-around">
                <h2 className="mb-4 text-2xl font-bold">{currentDay}</h2>
                <button
            ...
            <div className="custom-scrollbar h-2/3 overflow-y-auto">
            ...
            <HabitForm
                ...
                addNewHabit={addHabitToHabitsView}
            />
        </div>
    )
}
